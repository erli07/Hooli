 ...
 */
@interface OffersCollectionViewController : UICollectionViewController <UICollectionViewDelegateFlowLayout>
 ...
 */
- (PFUI_NULLABLE OfferCell *)collectionView:(UICollectionView *)collectionView
