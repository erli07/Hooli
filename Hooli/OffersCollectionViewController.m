...
#import "HLActivityIndicatorCollectionReusableView.h"
static NSString *const OfferCollectionViewCellIdentifier = @"offerCell";
static NSString *const HLQueryCollectionViewNextPageReusableViewIdentifier = @"nextPageView";
...
@property (nonatomic, strong) HLActivityIndicatorCollectionReusableView *currentNextPageView;
...
- (void)_setupWithClassName:(NSString *)otherClassName {
    ...
    self.parseClassName = kHLCloudOfferClass;
...
- (void)loadView {
    ...
    [self.collectionView registerClass:[OfferCell class]
            forCellWithReuseIdentifier:OfferCollectionViewCellIdentifier];
    [self.collectionView registerClass:[HLActivityIndicatorCollectionReusableView class]
            forSupplementaryViewOfKind:UICollectionElementKindSectionFooter
                   withReuseIdentifier:HLQueryCollectionViewNextPageReusableViewIdentifier];
...
- (OfferCell *)collectionView:(UICollectionView *)collectionView
    ...
    OfferCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:OfferCollectionViewCellIdentifier
                                                                           forIndexPath:indexPath];
    
    [cell updateCellWithPFObject:object];
...
- (HLLoadingView *)loadingView {
    if (!_loadingView) {
        _loadingView = [[HLLoadingView alloc] initWithFrame:CGRectZero];
    }
    return _loadingView;
}
