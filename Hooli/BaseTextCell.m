...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.contentLabel setNumberOfLines:10];
...
//    }
//    
    [self.nameButton setTitle:[[PFUser currentUser]objectForKey:kHLUserModelKeyUserName] forState:UIControlStateNormal];
    [self.nameButton setTitle:[[PFUser currentUser]objectForKey:kHLUserModelKeyUserName] forState:UIControlStateHighlighted];
