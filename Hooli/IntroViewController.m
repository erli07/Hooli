...
static NSString * const sampleDescription2 = @"Find your favorite event nearby";
...
- (void)showIntroWithCrossDissolve {
   ...
   // page1.desc = @"海圈圈, 你海外生活的好帮手";
    page1.desc = @"Your life assistant.";
  ...
  //  page2.desc = @"无论是御宅族，社交达人还是户外爱好者，\n在这里你会找到最志同道合的小伙伴\n和意想不到的惊喜^_^";
    page2.desc = @"Life is fun! We help you to discover fun things!";
    page2.bgImage = [UIImage imageNamed:@"bg2"];
    page2.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"together"]];

    EAIntroPage *page3 = [EAIntroPage page];
    page3.titleIconPositionY = 120;
    page3.title =sampleDescription3;
    page3.desc = @"Spend less money! We help you to find cheap and good stuff！";
   // page3.desc = @"告别封闭的小圈子，生活本就丰富多彩！";
    page3.bgImage = [UIImage imageNamed:@"bg3"];
    page3.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"crowd"]];
