...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    //---------------------------------------------------------------------------------------------------------------------------------------------
    if(message[PF_MESSAGES_EVENT]){
        
        PFObject *messageObject = message[PF_MESSAGES_EVENT];
        [imageUser setFile:messageObject[@"thumbnail"]];
        [imageUser loadInBackground];
        
    }
    else{
        
        PFUser *toUser = message[PF_MESSAGES_TOUSER];
        [imageUser setFile:toUser[PF_USER_PICTURE]];
        [imageUser loadInBackground];
