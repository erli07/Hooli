...
NSString *const kHLUserModelKeySignature = @"signature" ;
NSString *const kHLUserModelKeyAge = @"age";
NSString *const kHLUserModelKeyHobby = @"hobby";
NSString *const kHLUserModelKeyWork = @"work";
...
NSString *const kHLCloudMessagesClass = @"Messages";
NSString *const kHLCloudChatClass = @"Chat";
