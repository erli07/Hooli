...
#define		PF_USER_FULLNAME_LOWER				@"username"             //	String
...
#define		PF_MESSAGES_EVENT					@"event"				//	Pointer to Event Class
#define		PF_MESSAGES_GROUPID					@"groupId"				//	String
#define		PF_MESSAGES_DESCRIPTION				@"description"			//	String
#define		PF_MESSAGES_TOUSER				    @"toUser"				//	Pointer to User Class
