...
@interface ItemDetailsHeaderView ()
...
@implementation ItemDetailsHeaderView
...
- (void)setLikeUsers:(NSMutableArray *)anArray {
    likeUsers = [anArray sortedArrayUsingComparator:^NSComparisonResult(PFUser *liker1, PFUser *liker2) {
        NSString *displayName1 = [liker1 objectForKey:kHLUserModelKeyUserName];
        NSString *displayName2 = [liker2 objectForKey:kHLUserModelKeyUserName];
...
//        }
        ...
        // Create name label
        NSString *nameString = [self.photographer objectForKey:kHLUserModelKeyUserName];
